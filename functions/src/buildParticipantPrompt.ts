...
export function buildParticipantPrompt(
  ...
  return [
    ...
    '7. confidence is an integer from 0 to 100, evaluated using the confidence rubric below.',
    ...
    '- 75-89: Strong match. Clear evidence for most needs, with only minor gaps.',
    '- 60-74: Moderate match. Relevant background but incomplete role or sector evidence.',
    '- 40-59: Weak match. Broad similarity only, or limited evidence.',
    '- 0-39: Poor match or insufficient evidence.',
    'Do not give every candidate the same confidence. Use different scores when the evidence differs.',
    '',
    ...
    '',
    'Return ONLY this exact JSON shape. Do not wrap it in markdown. Do not rename keys:',
    '{',
    '  "participants": [',
    '    {',
    '      "userId": "candidate-id-from-list",',
    '      "suggestedRole": "Mentor",',
    '      "relationshipType": "mentor_match",',
    '      "reason": "One concise evidence-based sentence.",',
    '      "confidence": 82,',
    '      "riskFlags": [],',
    '      "suggestedNextAction": "Send intro invite",',
    '      "rank": 1',
    '    }',
    '  ]',
    '}',
